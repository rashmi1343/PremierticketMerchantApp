...
import 'package:ptk_merchant/login/view/validation_item.dart';
...
class ValidationProvider with ChangeNotifier {
  ...
  ValidationItem get fname => _fname;

  ValidationItem get lname => _lname;
  ...
  String? validateName(String value) {
    if (value.length >= 2) {
      ...
      _name = ValidationItem(null, "User Name must be at least 2 characters");
    }
    notifyListeners();
    return null;
  }
  ...
  String? validateFirstName(String value) {
    if (value.length >= 2) {
      ...
      _fname = ValidationItem(null, "First Name must be at least 2 characters");
    }
    notifyListeners();
    return null;
  }
  ...
  String? validateLastName(String value) {
    if (value.length >= 2) {
      ...
      _lname = ValidationItem(null, "Last Name must be at least 2 characters");
    }
    notifyListeners();
    return null;
  }
  ...
  String? validateCity(String? value) {
    if (value!.isEmpty) {
      ...
      return "Address must be at least 3 characters in length!";
    }
    notifyListeners();
    return null;
  }
  ...
  String? validateAddress(String value) {
    ...
    if (value.length >= 2) {
      ...
      _address =
          ValidationItem(null, "Address must be greater than 2 characters!");
    } else {
      _address = ValidationItem(value, null);
    }
